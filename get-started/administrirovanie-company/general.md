...
* использовать данные компании в интерфейсе и интеграциях
{% endhint %}
...
{% hint style="info" %}
Эти параметры используются в интерфейсе платформы и при интеграциях.
{% endhint %}
...
* скопировать ID для интеграций или поддержки
