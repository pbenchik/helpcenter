...
> ### С помощью блока Tracker Data вы можете просматривать всю информацию, связанную с источником трафика и кампанией.
...
{% hint style="info" %}
**Выбор отображаемых данных настраивается в:**
